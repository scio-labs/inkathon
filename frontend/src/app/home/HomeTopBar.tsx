  ...
  return (
    <>
      <Link
        ...
        className="absolute left-0 right-0 top-0 z-10 flex items-center justify-center whitespace-pre-wrap bg-gray-900 px-2 py-3 text-center text-sm font-semibold text-white/75 hover:text-white"
      >
